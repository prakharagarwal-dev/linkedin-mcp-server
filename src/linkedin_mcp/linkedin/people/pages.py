...
from linkedin_mcp.linkedin.identifiers import PROFILE_SLUG_SEGMENT_PATTERN
...
from linkedin_mcp.linkedin.urls import canonical_profile_url, profile_slug_from_url
